  ...
  return (
    <section id="features" className="container-fluid mx-auto px-6 py-20 bg-white/50 backdrop-blur-sm">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold mb-6 bg-linear-135 from-eveo to-eveo-dark bg-clip-text text-transparent uppercase">
          {t('features.title')}
        </h2>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="text-center p-8 rounded-3xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-purple-100">
          <div className="w-20 h-20 bg-linear-135 from-eveo to-eveo-dark rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
