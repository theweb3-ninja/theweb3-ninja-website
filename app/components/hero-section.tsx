...
export const HeroSection = ({ onCTAClick }: HeroSectionProps) => {
  ...
  return (
    <section className="min-h-screen flex flex-col container-fluid mx-auto px-6 bg-gradient-to-br from-theweb3ninja-light/5 via-purple-50/50 to-purple-300/20">
      ...
      <div className="text-center max-w-6xl mx-auto pt-30 min-h-screen flex flex-col justify-center gap-2 md:gap-5">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8 leading-tight">
          <span className="bg-linear-135 from-theweb3ninja to-theweb3ninja-dark bg-clip-text text-transparent uppercase">
            {t('hero.title')}
          </span>
          <br />
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          ...
          <Card className="p-8 backdrop-blur-sm border-0 shadow-xl rounded-3xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-white/90">
            <CardContent className="p-0">
              <div className="w-16 h-16 bg-linear-135 from-theweb3ninja to-theweb3ninja-dark rounded-2xl flex items-center text-white justify-center mx-auto mb-6">
              ...
              <Button
                ...
                className="w-full rounded-2xl h-12 bg-linear-135 from-theweb3ninja to-theweb3ninja-dark hover:from-theweb3ninja-light hover:to-theweb3ninja text-white font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                {t('hero.organizerCta')}
              </Button>
            </CardContent>
