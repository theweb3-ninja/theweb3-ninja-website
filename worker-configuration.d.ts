/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 346bfeceb96a412ea62a3abac4ef0419)
// Runtime types generated with workerd@1.20250816.0 2025-08-15 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		KV_THEWEB3NINJA: KVNamespace;
		CF_ACCOUNT_ID: "8207be57dc3a88f50bc29b302ef959ed";
		ZONE_ID: "7a38e3c80fdc306f010604a09801d180";
		EMAIL_LIST_ID_ENV: "4ae43d72-d43d-11ef-8467-6f7dbc1a852e";
		VITE_ENV: string;
		VITE_DEBUG: string;
		VITE_DOMAIN_GLOBAL: string;
		VITE_EMAIL_SECURITY: string;
		VITE_FEATURES: string;
		VITE_FORCE_STRICT_MODE: string;
		VITE_MEASUREMENT_ID: string;
		CLOUDFLARE_EMAIL: string;
		CLOUDFLARE_API_TOKEN: string;
		EMAILOCTOPUS_API_KEY_ENV: string;
		VITE_DOMAIN_EVEO_GLOBAL: string;
		VITE_DOMAIN_EVEO_ITALY: string;
		VITE_DOMAIN_EVEO_SPAIN: string;
		VITE_EVEO_FEATURES: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "ZONE_ID" | "EMAIL_LIST_ID_ENV" | "VITE_ENV" | "VITE_DEBUG" | "VITE_DOMAIN_GLOBAL" | "VITE_EMAIL_SECURITY" | "VITE_FEATURES" | "VITE_FORCE_STRICT_MODE" | "VITE_MEASUREMENT_ID" | "CLOUDFLARE_EMAIL" | "CLOUDFLARE_API_TOKEN" | "EMAILOCTOPUS_API_KEY_ENV" | "VITE_DOMAIN_EVEO_GLOBAL" | "VITE_DOMAIN_EVEO_ITALY" | "VITE_DOMAIN_EVEO_SPAIN" | "VITE_EVEO_FEATURES">> {}
}
